namespace Library_Management_System.Common.Exceptions
{
    ...
    public sealed class ApiServerException(string message)
    ...
    public abstract class DatabaseException(
        ...
        int statusCode = StatusCodes.Status500InternalServerError) : ApiException(message, statusCode)
    {
